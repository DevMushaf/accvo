...
function invoiceLogo(ctx: InvoicePdfContext, variant: InvoiceLogoVariant): string {
...
function buildCorporate(ctx: InvoicePdfContext): string {
  ...
  const navy = '#134E4A';
  const logo = invoiceLogo(ctx, 'onLight');
  ...
  <div style="position:relative;margin:-36px -40px 32px;padding:32px 40px 28px;overflow:hidden;border-bottom:1px solid #E5E7EB;">
    ...
    <div style="position:relative;z-index:1;display:flex;justify-content:space-between;align-items:flex-start;gap:24px;flex-wrap:wrap;">
      <div style="flex:1;min-width:220px;">
        ...
        ${tagline}
        <p style="margin:20px 0 14px;font-size:34px;font-weight:800;color:${blue};letter-spacing:0.03em;line-height:1;">INVOICE</p>
